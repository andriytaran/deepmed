...
from lib.dataset import breast_cancer_by_age, \
...
class USStatisticsView(GenericAPIView):
    serializer_class = DiagnosisSerializer
    permission_classes = (IsAuthenticated,)
    ...
    def get(self, request):
        ...
        data['breast_cancer_by_state'] = breast_cancer_by_state_response

        breast_cancer_at_a_glance_response = breast_cancer_at_a_glance2()
        data['breast_cancer_at_a_glance'] = breast_cancer_at_a_glance_response

        breast_cancer_by_age_response = breast_cancer_by_age(collection)
        data['breast_cancer_by_age'] = breast_cancer_by_age_response
