...
def psa_recode(document):
    if document['psa-value'] not in ['Blank(s)', 0, 997, 998, 999]:
        return document['psa-value']
    return None
...
if __name__ == '__main__':
    pprint(display_group('stage-2004'), width=100)
    pprint(display_group('stage-2010'), width=100)
    # pprint(display_group('gleason-comb1'))
